...
{
    public class CongratulationViewModel : NotificationObject
    {
        ...
        public CongratulationViewModel(IUnityContainer container)
        {
            Debug.WriteLine("CongratulationViewModel constructor");
        ...
        {
            Debug.WriteLine("CongratulationViewModel deconstructor");
        }
        ...
        {
            Debug.WriteLine("CongratulationViewModel subscribe event");
        ...
        private void SigninResponseEventHandler(ProtoMessage message)
        {
            ...
            if (status)
            {
                ...
                Debug.WriteLine("enter wheesper from pw reset scenory");
